...
namespace LilSnippers_TEST
{
    ...
    public partial class LilSnippers_TESTEntities : DbContext
    {
        public LilSnippers_TESTEntities()
            : base("name=LilSnippers_TESTEntities")
        {
        }
