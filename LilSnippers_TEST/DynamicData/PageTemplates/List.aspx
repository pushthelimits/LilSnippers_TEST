<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="List.aspx.cs" Inherits="LilSnippers_TEST.List" %>
...
<%--            <fieldset id="MultiSearchFieldSet" class="DD" runat="server" visible="True">
                <asp:TextBox ID="txbMultiColumnSearch" CssClass="DDTextBox" runat="server" Height="20px" Width="150px" />
                <asp:Button ID="btnMultiColumnSearchSubmit" CssClass="DDControl" runat="server" Text="Search"
                    OnClick="btnMultiColumnSearch_Click" Height="20px" Width="75px" />
