...
namespace LilSnippers_TEST
{
    public partial class ListDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // Makes the Search feature visible only on the Client table

            if (table.DisplayName == "Clients") { MultiSearchFieldSet.Visible = true; }
            else
        ...
        // Code for the Search feature on the Client table
       ...
       // Makes the pagination on the grid work with the search feature... sort of
