<%@ Control Language="C#" CodeBehind="Decimal_Edit.ascx.cs" Inherits="LilSnippers_TEST.Decimal_EditField" %>


<asp:TextBox ID="TextBox1" runat="server" CssClass="DDTextBox" Text='<%# FieldValueEditString %>' Columns="10" TextMode="SingleLine"></asp:TextBox>
